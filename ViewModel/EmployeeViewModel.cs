...
namespace Module02Exercise01.ViewModel
{
...

    {
        ...
        public EmployeeViewModel()
        {
            ...
            {
                new Employee {FirstName = "CJ", LastName = "Nuguid", Position = "Employee", Department = "HR", IsActive = false },
                new Employee {FirstName = "BJ", LastName = "Suguid", Position = "Employee", Department = "CCS", IsActive = true },
                new Employee {FirstName = "Richard", LastName = "Darwin", Position = "President", Department = "HR", IsActive = true },
                new Employee {FirstName = "Andrei", LastName = "Agbisit", Position = "Seller", Department = "Shopee", IsActive = false }
